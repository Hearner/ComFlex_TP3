...
public abstract class Controller {
  ...
  public static class ComponentImpl implements Controller.Component, Controller.Parts {
    ...
    protected void init_write() {
      assert this.write == null: "This is a bug.";
      this.write = this.implementation.make_write();
      if (this.write == null) {
      	throw new RuntimeException("make_write() in impl.Controller shall not return null.");
      }
    }
   ...
   * 
   */
  protected abstract IWrite make_write();
